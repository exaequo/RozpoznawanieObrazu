...
{
	return std::vector<std::string>{ /*"whitePixelCount",*/ "whitePixelOnTopHalfCount", "whitePixelOnBottomHalfCount", "leftSideShape", "rightSideShape", "topShape", "bottomShape","area", "ratio" /*,"centerWidth", "centerHeight",*/ ,"distanceCenter"};
}
