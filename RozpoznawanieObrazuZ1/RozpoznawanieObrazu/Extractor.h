...
public:
	...
	void extractAttributes(const dataVector& data, std::vector<unsigned char> &labels, std::vector<int> &whichAttributesToExtract);
...
protected:
	...
	std::vector<int> attributesToExtract;
